...
namespace Jukebox
{
    ...
    public partial class MainView : Form
    {
        ...
        public MainView()
        {
            ...
            mnuShuffle.Checked = Jukebox.Properties.Settings.Default.shuffle;
            mnuRepeat.Checked = Jukebox.Properties.Settings.Default.repeat;
            mnuRepeatAll.Checked = Jukebox.Properties.Settings.Default.repeatAll;
        ...
        {
            if (_currentPlaylist.CurrentTrackIndex != _currentPlaylist.Tracks.Count - 1 || Jukebox.Properties.Settings.Default.repeatAll)
            {
        ...
        private void UpdateForm()
        {
            if (_currentPlaylist.TrackLoaded)
            {
                ...
                try
                {
                    ...
                    if (_currentPlaylist.PlayingAudio && btnPlay.BackgroundImage != Jukebox.Properties.Resources.Gnome_Media_Playback_Pause_32)
                    {
                        btnPlay.BackgroundImage = Jukebox.Properties.Resources.Gnome_Media_Playback_Pause_32;
                    }
                    else if (!_currentPlaylist.PlayingAudio && btnPlay.BackgroundImage != Jukebox.Properties.Resources.Gnome_Media_Playback_Start_32)
                    {
                        btnPlay.BackgroundImage = Jukebox.Properties.Resources.Gnome_Media_Playback_Start_32;
                    }
                }
                catch (Exception ex)
                {
        ...
        {
            Jukebox.Properties.Settings.Default.shuffle = !Jukebox.Properties.Settings.Default.shuffle;
            _currentPlaylist.Shuffle = Jukebox.Properties.Settings.Default.shuffle;
        }
        ...
        {
            Jukebox.Properties.Settings.Default.repeat = !Jukebox.Properties.Settings.Default.repeat;
            _currentPlaylist.Repeat = Jukebox.Properties.Settings.Default.repeat;
        }
        ...
        {
            Jukebox.Properties.Settings.Default.repeatAll = !Jukebox.Properties.Settings.Default.repeatAll;
            _currentPlaylist.RepeatAll = Jukebox.Properties.Settings.Default.repeatAll;
        }
